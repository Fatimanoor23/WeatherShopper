...
//   await btn.click();
//   await expect(btn).toBeClickable();  await expect(browser).toHaveUrlContaining('/cart');
//   // await browser.url('https://weathershopper.pythonanywhere.com/cart');
//   });
  
//   When('I verify that the shopping cart looks correct', async () => {
//     const cartItems=$(`//div//table[contains(@class,"table table-striped")]//following::th/following::td[contains(.,"Almond") and contains(.,"Aloe")]`);
...
//     //const id=await $(`.stripe_checkout_app`);
